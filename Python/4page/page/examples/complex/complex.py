...
w = None
def create_Complex_example(root, param=None):
    ...
    complex_support.init(w, w_win, param)
    return w_win
...
class Complex_example:
    def __init__(self, master=None):
        ...
        self.TNotebook1.place(relx=0.11,rely=0.14,relheight=0.83,relwidth=0.79)
        ...
        self.Label1.place(relx=0.17,rely=0.25,height=27,width=97)
        ...
        self.Label2.place(relx=0.33,rely=0.39,height=27,width=125)
